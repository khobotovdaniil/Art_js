...
/* harmony import */ var _modules_pictuteSize__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/pictuteSize */ "./src/js/modules/pictuteSize.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_pictuteSize__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
var drop = function drop() {
  ...
  function unhighlight(item) {
    var itemStyle = item.closest('.file_upload').style;
...
var filter = function filter() {
  ...
  var eventClick = function eventClick(selector) {
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeight - 10) {
  ...
  openByScroll('.fixed-gift'); // showModelByTime('.popup-consultation', 60000);
};
